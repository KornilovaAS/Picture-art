...
var modals = function modals() {
  ...
  var btnPressed = false; // аргументы: чем открываем, какое окно открываем, как закрываем
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        // переменная со всеми модальными окнами
    scroll = calcScroll();
    trigger.forEach(function (elem) {
      elem.addEventListener('click', function (event) {
        ...
        windows.forEach(function (item) {
          item.style.display = "none"; // добавляем анимацию из animate css библиотеки
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      var display; // получаем все модальные окна, т.к. к пер windows из этой функции доступа не имеем
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      if (!btnPressed && window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight) {
        ...
        document.querySelector(selector).click(); // решение для старых бразеров 
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  var items = document.querySelectorAll(slides); // функция отвечающая за перемещение слайд индекса=слайдера 
